...
The need for this solution is even more evident when we see what the count for the eligible mentors was before and after those 2 months were added. Below are images that include the code for the queries and the results in tables.
